            ...
            onValue(dato, (snapshot) => {
                ...
                if (data) {
                    ...
                    const arreglo = Object.keys(data).map(key => ({
                        id: key,
                        cedula: data[key].perfil.cedula,
                        nombreCompleto: data[key].perfil.nombre,
                        carrera: data[key].academico.carrera,
                        horario: data[key].academico.horario,
                        notaFinal: data[key].academico.calificaciones.notaFinal,
                        ...data[key]
                    }));
